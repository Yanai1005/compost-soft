...
<body>
    ...
    <div class="table-container">
        <div class="table-section">
            ...
            <table>
                ...
                $dbname = "your_database_name"; // Change as needed
                ...
                $sql = "SELECT * FROM temperature_data"; // Adjust your table name
        ...
        <div class="table-section">
            ...
            <table>
                ...
                // Fetch humidity data
                $sql = "SELECT * FROM humidity_data"; // Adjust your table name
                $result = $conn->query($sql);
    ...
    <div class="tabs">
        ...
        <div class="tab" onclick="openTab(event, 'folder4')">Others</div>
    </div>
      ...
      <!-- This is just a sample of how it looks like, it will be replaced with data from either AWS or MySQL-->
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="#">26.0</a></td>
                <td>
                    <button class="condition-button" onclick="heaterButtonAction()">Condition</button>
    ...
    <script>
        ...
        function heaterButtonAction() {
            alert("Heater started!");
